                        ...
                        arr.map((item, i) => {
                            return (
                                <tr key={i} className="border-b-2">
                                    ...
                                    <td className="text-center text-[#0F2C64] py-4">Marriage OldCases OldCases</td>
                                    <td className="text-center text-[#0F2C64] py-4">Lorem  OldCases  Ipsum</td>
                                    <td >
                                        <div className="flex flex-row py-4 items-center ">
                                            <img src="/assets/user.png" alt="logo not found " className="w-10 h-10 rounded-full" />
                                            <div className="text-[#0F2C64]"> Advocate NewCases </div>
                                        </div>
                                    </td>
                                    <td className=" py-4 ">

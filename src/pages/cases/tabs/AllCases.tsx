          ...
          arr.map((item ,i)=>{
            return(
              ...
              <td className="border-r text-[#0F2C64] pl-4 py-4">JudgmentCases</td>
                <td className="text-center text-[#0F2C64] py-4">Marriage Lawyer All cases</td>
                <td className="text-center text-[#0F2C64] py-4">Lorem Ipsum All Casews</td>
                <td >
                  <div className="flex flex-row py-4 items-center ">
                    <img src="/assets/user.png" alt="logo not found " className="w-10 h-10 rounded-full" />
                 <div className="text-[#0F2C64]"> Advocate Loreum Ipsum </div>
                 </div>
                </td>
                <td className=" py-4 ">
